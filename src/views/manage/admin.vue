<template>
  <div class="app-container">
    <!-- 搜索 -->
    <div v-permission="'admin.admin@search'" class="filter-container">
    ...
    <el-row style="margin-bottom: 10px;">
      <el-col :xs="24" :sm="24" :lg="24">
          ...
          <el-button v-permission="'admin.admin@save'" v-waves type="success" icon="el-icon-plus" size="small" @click="handleCreate" >添加管理员</el-button>      
          <el-button v-permission="'admin.admin@delall'" v-waves :loading="deleting" 
          :disabled="buttonDisabled" size="small" type="danger" icon="el-icon-delete" 
           @click="handleDeleteAll()">批量删除</el-button>

        <el-tooltip content="更多" placement="top" v-permission="'admin.admin@changeall'">
    ...
    >
      ...
      <el-table-column label="操作" align="center" width="180px" class-name="small-padding fixed-width" fixed="right">
        <template slot-scope="scope">
            <el-button v-permission="'admin.admin@edit'" v-waves type="primary" icon="el-icon-edit-outline" size="small" @click="handleUpdate(scope.$index,scope.row.id)" >编辑</el-button>
            <el-button v-permission="'admin.admin@del'" v-waves :loading="scope.row.delete" type="danger" icon="el-icon-delete" size="small" @click="handleDelete(scope.$index,scope.row.id)" >删除</el-button>
        </template>
      </el-table-column>
    </el-table>
